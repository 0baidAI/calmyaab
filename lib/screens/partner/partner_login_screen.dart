...
class _PartnerLoginScreenState extends State<PartnerLoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // Check if partner and if approved
      ...
      if (!doc.exists) {
        ...
        setState(() {
          _loading = false;
          _error = 'No partner account found with this email.';
        });
        return;
      }
      ...
      if (status == 'pending') {
        ...
        setState(() {
          _loading = false;
          _error = 'Your account is pending approval. Please wait 24 hours.';
        });
        return;
      }
      ...
      if (status == 'rejected') {
        ...
        setState(() {
          _loading = false;
          _error = 'Your application was rejected. Contact support for help.';
        });
        return;
      }

      // Active — go to partner dashboard
      if (mounted) context.go('/partner');
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Access your hiring dashboard.',
                  ...
                  Center(child: Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () => context.go('/partner-register'),
